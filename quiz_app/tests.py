...
class QuizTestCase(TestCase):
    ...
    def test_get_quiz_success(self):
        ...
        """
        url = reverse('get_quiz', kwargs={'quiz_id': self.quiz.id})
    ...
    def test_get_quiz_not_found(self):
        ...
        url = reverse('get_quiz', kwargs={'quiz_id': uuid4()})
        response = self.client.get(url)
    ...
    def test_update_quiz_success(self):
        ...
        """
        url = reverse('update_quiz', kwargs={'quiz_id': self.quiz.id})
        update_data = {
    ...
    def test_partial_update_quiz_success(self):
        ...
        """
        url = reverse('partial_update_quiz', kwargs={'quiz_id': self.quiz.id})
    ...
    def test_delete_quiz_success(self):
        ...
        """
        url = reverse('delete_quiz', kwargs={'quiz_id': self.quiz.id})
