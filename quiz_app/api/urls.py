...
urlpatterns = [
    ...
    path("attempts/<int:attempt_id>/answer/", save_quiz_answer_view, name="save_answer"),
    path("attempts/<int:attempt_id>/complete/", complete_quiz_view, name="complete_quiz"),
    path("attempts/<int:attempt_id>/results/", get_quiz_results_view, name="quiz_results"),
