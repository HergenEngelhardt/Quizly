...
urlpatterns = [
    ...
    path("attempts/<str:attempt_id>/answer/", save_quiz_answer_view, name="save_answer"),
    path("attempts/<str:attempt_id>/complete/", complete_quiz_view, name="complete_quiz"),
    path("attempts/<str:attempt_id>/results/", get_quiz_results_view, name="quiz_results"),
